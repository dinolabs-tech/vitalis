    ...
    <section id="about" class="about section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <div class="content">
              <h4>Quality Healthcare You Can Rely On</h4>
              <p>
                At Vitalis, we believe that quality healthcare begins with compassion, expertise, and innovation.
                Our team of dedicated doctors, nurses, and specialists work together to deliver comprehensive medical care using the latest technology and evidence-based practices.

                We are more than a hospital — we are a trusted partner in your health journey. Whether you’re visiting for a routine check-up, emergency care, or specialized treatment, MediTrust ensures every patient receives personalized attention in a safe and comfortable environment.
              </p>
              <h4>Our Mission:</h4>
              <p>
                To provide affordable, accessible, and reliable healthcare for individuals and families, while maintaining the highest medical standards.
              </p>
              <h4>Our Vision:</h4>
              <p>
                To be a leading healthcare provider known for patient-centered service, cutting-edge facilities, and commitment to community well-being.
              </p>
